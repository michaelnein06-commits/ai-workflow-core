...
description: Clarify ambiguous requirements through focused dialogue before implementation. Run automatically when working with github issues.  Use when requirements are unclear, features are complex (>2 days), or involve cross-team coordination. Ask two core questions - Why? (YAGNI check) and Simpler? (KISS check) - to ensure clarity before coding.
---
...
When working with github issues or any form of spec, detect vague requirements:
